...
- Some projects use git worktrees for parallel branch work (e.g. `retrogamingstores`,
  `pandoraplatinum`). Worktree structure varies per project and is NOT assumed.
