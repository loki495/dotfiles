...
- Examples: `stocker` → `stocker`, `new.myteambuilder.com` → `new-teambuilder`
...
**OpenCart reference:** `~/www/retrogamingstores.com/retrogamingstores-local/setup-dev-container.sh`
