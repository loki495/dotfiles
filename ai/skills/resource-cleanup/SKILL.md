...
description: Scratch scripts and fixed/reused resource paths (sockets, lock/PID files) must self-clean before binding. Triggered when writing scripts that bind a reused resource path.
---
